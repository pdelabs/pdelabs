...
const es: typeof en = {
    ai: {
        hero: { title: "Agentes de IA que llegan a", emphasis: "producción.", subtitle: "Sistemas RAG, bucles agénticos y agentes autónomos — diseñados, evaluados y puestos en producción." },
        ...
        anatomySteps: {
            ...
            loop: { title: "Bucle", description: "Planificar, actuar, observar, corregir — hasta cumplir el objetivo o hasta que un presupuesto diga basta." },
